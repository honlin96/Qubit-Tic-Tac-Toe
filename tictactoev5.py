...
class MainApp:                         ### (1)
    def __init__(self, Parent):      ### (1a)
        ...
        self.buttonarr = [self.button7, self.button8,self.button9, self.button4,self.button5,self.button6,self.button1,self.button2,self.button3]
    #functions
    def btn1click(self):
        self.reg0 = 7
    ...
    def btnClick(self):
        ...
        if move == 'm':
            ...
            if move[:2] != 'cx':
                ...
                targetbutton = self.buttonarr[reg1-1]
